...
public class MatrixUtils {
     ...
     */
    public static void calcTransitionMatrix(Matrix4 mat, com.mygdx.game.math.Rect src, com.mygdx.game.math.Rect dst) {
     ...
     * @param dst итоговый квадрат
     */
    public static void calcTransitionMatrix(Matrix3 mat, com.mygdx.game.math.Rect src, com.mygdx.game.math.Rect dst) {
        float scaleX = dst.getWidth() / src.getWidth();
        float scaleY = dst.getHeight() / src.getHeight();
